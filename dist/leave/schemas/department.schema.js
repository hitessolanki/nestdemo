...
exports.DepartmentSchema = exports.Leave = void 0;
...
], Leave.prototype, "departmentname", void 0);
__decorate([
    mongoose_1.Prop({ type: Number, required: false, default: 0 }),
    __metadata("design:type", Number)
], Leave.prototype, "noofemployee", void 0);
__decorate([
    mongoose_1.Prop({ type: Number, required: false, default: 0 }),
    __metadata("design:type", Number)
], Leave.prototype, "maxsalary", void 0);
__decorate([
    mongoose_1.Prop({ type: Boolean, required: false, default: true }),
    __metadata("design:type", Boolean)
], Leave.prototype, "active", void 0);
__decorate([
    mongoose_1.Prop({ type: Boolean, required: false, default: false }),
    __metadata("design:type", Boolean)
], Leave.prototype, "isdeleted", void 0);
Leave = __decorate([
    mongoose_1.Schema()
], Leave);
exports.Leave = Leave;
exports.DepartmentSchema = mongoose_1.SchemaFactory.createForClass(Leave);
